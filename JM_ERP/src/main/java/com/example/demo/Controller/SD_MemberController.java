...
// 고객 구매내역 조회
	...
	public String memberSearch(Model model, @RequestParam(value = "page", defaultValue = "0") int page,
		...
		// 기존 로직 유지
	    Page<SD_Purchase> paging = purchaseService.searchAll(page);
	    if (memberId != null && !memberId.isEmpty()) {
	        paging = purchaseService.searchByMemberId(memberId, PageRequest.of(page, 10));
	    }
...
//		model.addAttribute("currentUrl", currentUrl);
//		
//		// 사원에 따라 목록 검색한 후 'purchase'라는 이름으로 모델에 저장
//	    List<SD_Purchase> purchase = purchaseService.getList(); 
...
//	public String RegiMember(@RequestParam("memberId") String memberId,
