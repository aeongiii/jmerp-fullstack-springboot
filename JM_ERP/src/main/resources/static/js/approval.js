	...
	if(div.getAttribute("id")==2){		
		if(div.getAttribute("name")==authList[0]){
			for(var i=0; i<button.length; i++){
				...
				for(var i=0; i<button.length; i++){
					button[i].classList.toggle('btn-secondary');
