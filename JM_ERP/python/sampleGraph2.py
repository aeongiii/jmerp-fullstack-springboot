...
try:
    ...
    for category in categories:
        ...
        # 쿼리 실행
        query = f"SELECT product_name, total_saleea FROM SD_NBProduct WHERE category = '{category}'"
        ...
        # 카테고리별로 total_sale_ea의 최댓값을 찾아서 각 그래프 y축의 최댓값 설정
