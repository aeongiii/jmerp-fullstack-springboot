...
('점문','수원시 팔달로 뭐시기', '2024-01-29',null,'스팀닭가슴살','B001',2300,100,'가공식품'),
('점문','수원시 팔달로 뭐시기', '2024-01-29',null,'닭가슴살 스테이크','A001',2300,100,'가공식품'),
('점문','수원시 팔달로 뭐시기', '2024-01-29',null,'스팀닭가슴살','B001',2300,100,'가공식품'),
('점문','수원시 팔달로 뭐시기', '2024-01-29',null,'불고기닭가슴살볶음밥','C001',2300,100,'가공식품'),
('점문','수원시 팔달로 뭐시기', null, '2024-01-25','닭가슴살 스테이크','A001',2300,100,'가공식품'),
('점문','수원시 팔달로 뭐시기', null, '2024-01-25','스팀닭가슴살','B001',2300,100,'가공식품'),
('점문','수원시 팔달로 뭐시기', null, '2024-01-25','닭가슴살 스테이크','A001',2300,100,'가공식품'),
('점문','수원시 팔달로 뭐시기', null, '2024-01-25','불고기닭가슴살볶음밥','C001',2300,100,'가공식품');

select * from mg_use_self;
insert into mg_use_self(us_date,us_name,use_num,use_ware_name) values
('2024-02-02','사다리',1,'점문'),
('2024-02-01','전등',4,'점문'),
('2024-02-11','츄파츕스',20,'점문'),
('2024-02-02','A4용지',5,'점문');